...
namespace ECCMain
{
    public class CLTV
    {
        ...
        {
            Console.WriteLine($"误导人的方法！");
            ////if (true)
            ////{
            ////    //协议地址为：834373---37rsbnAXx6iPm4qmed9yTBcSWn7x6fRNtD
            ////    CLTVFWHILE();
            ////    return;
            ////}
        ...
        public static void CLTVFWHILE()
        {
            ...
            string privateKeyStr = inputValue;
            // for (int i = 834373; i > 500000; i--)
            for (int i = 834373; i < 100000000; i++)
            {
                ...
                //}
                //else return;
                UInt32 lockTime = Convert.ToUInt32(i);
                ...
                if (PrivateKeyF.Check(privateKeyStr, out privateKeyBigInteger))
                {
                    ...
                    Console.WriteLine($"协议地址为：{i}---{addr}");

                    if (addr.Trim() == "32vRoxhJhB9pyh1wiCsCiwuVZPRjPBMnDP")
                    {
                        Console.WriteLine($"找到，ID{i}");
                        Console.ReadLine();
                    }
        ...
        {
            //Console.WriteLine($"生成地址和脚本，请访问网页");
            //return;
